...
public class ProtocolUtil {
	...
	public static void write(OutputStream out, MyProtocol protocol) throws IOException {
		write(out, protocol, false);
	}

	public static void write(OutputStream out, MyProtocol protocol, boolean closeIO) throws IOException {
	...
	public static MyProtocol read(InputStream in) throws IOException {
