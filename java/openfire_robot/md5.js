...
function x(s, domain, name, pass) {
	var attribMatch = /([a-z]+)=("[^"]+"|[^,"]+)(?:,|$)/;

	var challenge = Base64.decode(s);
	...
	var A1 = MD5.hash(name + ":" + realm + ":" + pass) + ":" + nonce + ":" + cnonce;
	var A2 = 'AUTHENTICATE:' + digest_uri;

	var responseText = "";
	responseText += 'username=' + _quote(name) + ',';
	...
	//return responseText;
	return Base64.encode(responseText);
}