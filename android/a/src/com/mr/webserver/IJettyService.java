...
import com.mr.webserver.handler.DefaultHandler;
            ...
            public void handleMessage(Message msg) {
                switch (msg.getData().getInt("state")) {
                    case __STARTED: {
                        ...
                        // The PendingIntent to launch IJetty activity if the user
                        // selects this notification
                        PendingIntent contentIntent = PendingIntent.getActivity(
                                IJettyService.this, 0, new Intent(
                                        IJettyService.this, IJetty.class), 0
                        );

                        CharSequence text = getText(R.string.manage_jetty);

                        Notification notification = new Notification(
                                R.drawable.ijetty_stat, text,
