...
public class IJettyDownloader extends Activity {
    ...
    /**
     * Download activity is being stopped. Stop the httpclient (note that
     * onPause should always be called first, so the client should be null).
     *
     * @see android.app.Activity#onPause()
     */
    ...
    public void doDownload(final String url, final File warFile,
        ...
        try {
            ...
            mHandler.sendMessage(Message.obtain(mHandler,
                    __MSG_DOWNLOAD_FAILED, "Failed to start client"));
            return;
        }
        ...
        ContentExchange exchange = new ContentExchange() {
            ...
            protected void onResponseComplete() throws IOException {
                ...
                if (getResponseStatus() == HttpStatus.OK_200)
                    ...
                    mHandler.sendMessage(Message.obtain(mHandler,
                            __MSG_DOWNLOAD_FAILED, "Bad status: "
                                    + getResponseStatus()
                    ));
                }
            }
            ...
            protected void onConnectionFailed(Throwable ex) {
                closeOutputStream();
                mHandler.sendMessage(Message.obtain(mHandler,
                        __MSG_DOWNLOAD_FAILED, "Connection failed"));
            ...
            protected void onException(Throwable ex) {
                closeOutputStream();
                mHandler.sendMessage(Message.obtain(mHandler,
                        __MSG_DOWNLOAD_FAILED, "Exception"));
    ...
    public void install(File file, String path) {
        try {
            File webappDir = new File(IJetty.__JETTY_DIR + "/"
                    + IJetty.__WEBAPP_DIR);
